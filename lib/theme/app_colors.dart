...
class AppColors {
  ...
  static const Color secondary = Color(0xFF4FC08D);
  ...
  static const Color darkBgSecondary = Color(0xFF2C2C2C);
  static const Color darkBgTertiary = Color(0xFF363636);
  static const Color darkBorderLight = Color(0xFF404040);
  static const Color darkBorderMedium = Color(0xFF505050);
